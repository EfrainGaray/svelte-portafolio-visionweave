       ...
       <header id="site_header" class="header mobile-menu-hide">
         <div class="header-content">
           <div class="header-photo">
             <img src="img/main_photo.jpg" alt="Efrain Garay A.">
           </div>
           <div class="header-titles">
             <h2>Efrain Garay A.</h2>
             <h4>Ingeniero Informatico</h4>
           </div>
         </div>
         ...
         <div class="social-links">
           <ul>
             <li><a href="https://www.linkedin.com/in/efraingaray/" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
             <li><a href="https://web.facebook.com/efrapps" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
             <li><a href="https://twitter.com/schadel" target="_blank"><i class="fab fa-twitter"></i></a></li>
           </ul>
         </div>

         <div class="header-buttons">
           <a href="http://facebook.com" target="_blank" class="btn btn-primary">Download CV</a>
         </div>
                   ...
                   <div class="col-sm-12 col-md-12 col-lg-12">
                     <div class="title-block">
                       ...
                       <div class="owl-carousel text-rotation">                                    
                         <div class="item">
                           <div class="sp-subtitle">Tech Architect Leader</div>
                         </div>
                         
                         <div class="item">
                           <div class="sp-subtitle">Ingeniero Informatico</div>
                         </div>
                       </div>
                     </div>
                   </div>
                 ...
                 <div class="col-xs-12 col-sm-12">
                   <div class="clients owl-carousel">
                     ...
                     <div class="client-block">
                       <a href="https://localhos" target="_blank" title="Logo">
                   ...
                   <div class="fw-pricing clearfix row">
                     ...
                     <div class="fw-package-wrap col-md-6 ">
                       <div class="fw-package">
                         ...
                         <div class="fw-button-row">
                           <a href="https://localhos" target="_self" class="btn btn-secondary">Free Trial</a>
                         </div>
                     ...
                     <div class="fw-package-wrap col-md-6 highlight-col ">
                       <div class="fw-package">
                         ...
                         <div class="fw-button-row">
                           <a href="https://localhos" target="_self" class="btn btn-primary">Free Trial</a>
                         </div>
                 ...
                 <div class="col-xs-12 col-sm-12">
                   ...
                   <div class="portfolio-content">
                     ...
                     <ul class="portfolio-filters">
                       <li class="active">
                         <a   href="https://localhos" class="filter btn btn-sm btn-link" data-group="category_all">All</a>
                       </li>
                       <li>
                         <a  href="https://localhos" class="filter btn btn-sm btn-link" data-group="category_detailed">Detailed</a>
                       </li>
                       <li>
                         <a  href="https://localhos" class="filter btn btn-sm btn-link" data-group="category_mockups">Mockups</a>
                       </li>
                       <li>
                         <a  href="https://localhos" class="filter btn btn-sm btn-link" data-group="category_soundcloud">SoundCloud</a>
                       </li>
                       <li>
                         <a  href="https://localhos" class="filter btn btn-sm btn-link" data-group="category_vimeo-videos">Vimeo Videos</a>
                       </li>
                       <li>
                         <a  href="https://localhos" class="filter btn btn-sm btn-link" data-group="category_youtube-videos">YouTube Videos</a>
                       </li>
                     </ul>
                   ...
                   <div class="blog-masonry two-columns clearfix">
                     ...
                     <div class="item post-1">
                       <div class="blog-card">
                         <div class="media-block">
                           <div class="category">
                             <a href="https://localhos" title="View all posts in Design">Design</a>
                           </div>
                         ...
                         <div class="post-info">
                           <div class="post-date">19 Ago 2023</div>
                           <a href="blog-post-1.html">
                     ...
                     <div class="item post-2">
                       <div class="blog-card">
                         <div class="media-block">
                           <div class="category">
                             <a href="https://localhos" title="View all posts in UI">UI</a>
                           </div>
                           <a href="blog-post-1.html">
                     ...
                     <div class="item post-2">
                       <div class="blog-card">
                         <div class="media-block">
                           <div class="category">
                             <a href="https://localhos" title="View all posts in E-Commerce">UI</a>
                           </div>
                           <a href="blog-post-1.html">
                       ...
                       <div class="fields clearfix">
                         <div class="left-column">
                           <div class="form-group form-group-with-icon">
                             <input id="form_name" type="text" name="name" class="form-control" placeholder="" data-error="Name is required.">
                             <span>Full Name</span>
                           ...
                           <div class="form-group form-group-with-icon">
                             <input id="form_email" type="email" name="email" class="form-control" placeholder="" data-error="Valid email is required.">
                           ...
                           <div class="form-group form-group-with-icon">
                             <input id="form_subject" type="text" name="subject" class="form-control" placeholder=""  data-error="Subject is required.">
                             <span>Subject</span>
                             <div class="form-control-border"></div>
                             <div class="help-block with-errors"></div>
                           </div>
                         ...
                         <div class="right-column">
                           <div class="form-group form-group-with-icon">
                             <textarea id="form_message" name="message" class="form-control" placeholder="" rows="7"  data-error="Please, leave me a message."></textarea>
                             <span>Message</span>
                             <div class="form-control-border"></div>
                             <div class="help-block with-errors"></div>
                           </div>
